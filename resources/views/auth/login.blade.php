            ...
            <form class="text-start w-full" action="{{route('login')}}" method="POST">
				@csrf
                    ...
                    <div class="text-center mb-7">
                        <button type="submit" class="w-full inline-flex items-center justify-center px-6 py-2.5 font-bold text-base text-white rounded-md transition-all duration-500 btn-brand"  type="submit"  id="SignIN" style="background-color: #5e85c4 !important; border-color: #5e85c4 !important; opacity: 1 !important; color: #fff !important;" disabled>تسجيل الدخول</button>
                    </div>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
										<div class="modal-dialog modal-dialog-scrollable">
											...
											<div class="modal-body" style="text-align: right; direction: rtl">
												...
												<br><h6><strong>الملكية الفكرية والبرامج والمحتوى</strong></h6>
												...
												<br><h6><strong>شروط الخدمة</strong></h6>
													<p>نحن نعمل بالشراكة مع مدققين خارجيين مستقلين وهيئات إصدار الشهادات التي يمكنها إصدار شهادة المنظمة الدولية للمعايير (الآيزو) لمستخدمي موقع ISOONLINE E SOLUTIONS LLC SPC عند الانتهاء بنجاح من عملية التدقيق. من المهم ملاحظة أن موقع ISOONLINE E SOLUTIONS LLC SPC ليس لديه صلاحية إصدار الشهادات لأنه ليس هيئة اعتماد ولا هيئة لإصدار الشهادات. يكون كل ترخيص لبرنامج ISOONLINE E SOLUTIONS LLC SPC صالحًا لمدة ثلاث سنوات، ويتوقف ذلك على إكمال ثلاث عمليات تدقيق سنوية بنجاح. إذا قمت بشراء نظامنا وتنوي الحصول على شهادة الآيزو، فيجب عليك مواصلة استخدام البرنامج وإثبات ذلك من خلال اجتياز عمليات التدقيق السنوية الثلاث. قد يؤدي عدم القيام بذلك إلى إلغاء شهادتك، وفي مثل هذه الحالات، لا يمكن أن يكون ISOONLINE E SOLUTIONS LLC SPC™ مسؤولاً عن ذلك.</p>
													
												<br><h6><strong> لإرجاع</strong></h6>
													...
													<br><h6><strong> الاسترداد (إذا كان ينطبق)</strong></h6>
												...
												<br><h6><strong> إخلاء المسؤولية</strong></h6>
												...
												<br><h6><strong> إخلاء المسؤولية فيما يخص ملكية العلامات التجارية وصور الأفراد والمحتوى المحمي بحقوق الطبع والنشر لجهة خارجية</strong></h6>
													...
													<br><h6><strong> التعويض</strong></h6>
												...
												<br><h6><strong> التعديلات والتغييرات</strong></h6>
													...
													<br><h6><strong> استقلالية بنود الاتفاقية</strong></h6>
												...
												<br><h6><strong> القانون الحاكم/ الولاية القضائية</strong></h6>
												...
												<br><h6><strong> كامل الاتفاقية</strong></h6>
												...
												<br><h6><strong> التواصل معنا</strong></h6>
