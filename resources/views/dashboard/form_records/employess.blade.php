                    ...
                    <div class="procedure_div">
                        <div class="row">
                            <div class="col-lg-12 text-right">
                              <a onclick="employeeForm()" class="addBtn">إضافة موظف</a>  &nbsp;<a onclick="employeeSkillForm()" class="addBtn">إضافة مهارات العمليات للموظف</a> &nbsp;<a onclick="employeeRecordForm()" class="addBtn"> إضافة سجل تدريب للموظف</a>
                            </div>
                        </div>
