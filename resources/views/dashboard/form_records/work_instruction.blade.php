    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <section id="procedure_section">
            <div class="row text-right">
                <div class="col-lg-12">
                    <p>إرشادات العمل هي إجراءات محلية تُستخدم لدعم أعمال الشركة. فإذا كنت تستخدم مستندات خارج هذا النظام،
                        فلا بأس طالما أنها تُضاف هنا ضمن المراجع. ويمكنك إضافتها من خلال تسجيل تفاصيل إرشادات العمل ووضع
                        ملخص موجز في قسم النطاق. كما يمكن استخدام هذا القسم لإضافة الأنشطة التي ينبغي عليك إدراجها ضمن
                        تدقيقك للعمليات</p>
