...
@section('myscript')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.input-file').forEach(function(fileInput) {

                fileInput.addEventListener('change', function() {
                    const wrapper = fileInput.closest('.custom-file-input-tag');
                    if (!wrapper) return;

                    const fileText = wrapper.querySelector('.file-text');
                    const fileChosen = wrapper.querySelector('.file-chosen');
