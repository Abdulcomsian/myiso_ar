...
class HazardController extends SimpleRegisterController
{
    ...
    protected function module()
    {
        return [
            ...
            'info_items' => ['الانزلاق والتعثر والسقوط', 'الأدوات الحادة أو الآلات', 'المركبات المتحركة','رفع الأحمال الثقيلة أو العمل المتكرر'],
            'add_label' => 'إضافة خطر',
            ...
            'label_field' => 'hazard',
            'fields' => [
                'hazard' => ['label' => 'الخطر', 'type' => 'text', 'required' => true, 'wide' => true, 'placeholder' => 'مثال: الانزلاق على أرضية مبللة، أدوات حادة'],
                'risk' => ['label' => 'المخاطرة / التأثير', 'type' => 'text', 'wide' => true, 'placeholder' => 'مثال: قد يتعرض موظف لكسر في الساق، قد يُصاب زائر، حروق شديدة'],
                'controls' => ['label' => 'الضوابط', 'type' => 'text', 'wide' => true, 'placeholder' => 'مثال: الحفاظ على جفاف الأرضية، استخدام واقيات الأدوات، اللافتات التحذيرية'],
