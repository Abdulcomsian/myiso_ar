                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <!--<td><?php echo e($count); ?></td>-->
                                ...
                                <button class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Notes History" value=""
                                    onclick="get_notes(<?php echo e($item->order_number); ?>);">
     ...
     <div class="modal fade" id="userNote" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
     <form class="kt-form kt-form--label-right" id="addusernotform" method="POST" action="<?php echo e(route('addusernote')); ?>"  enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
     ...
     function get_notes(id) 
        {
            document.getElementById("editcompanyid").value = id;
                    $.ajax({
                        type: "post",
                        url: "<?php echo e(url('/usernoteshistory')); ?>",
                        headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                        data: {
                            user_id: id,
                            _token: $('meta[name="csrf-token"]').attr('content')
        ...
        <?php $__env->startSection('myscript'); ?>
            ...
            $(document).ready(function() {
                ...
                $('.delete-qa_certification').on('click', function () {
                    ...
                    let AjaxUrl = "<?php echo e(url('/remove_qa_iso')); ?>";
                    $.ajax({
                        url: AjaxUrl,
                        type: "Post",
                        //dataType: "json",
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.success) {
                ...
                $('#note_id').val('');
                $('#_method').val('POST');
                $('#addusernotform').attr('action', '<?php echo e(route("addusernote")); ?>');
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/BLOCKSTORAGE/home/1629330.cloudwaysapps.com/jrxyspjtdv/public_html/public/ar/resources/views/admin/dashboard/admin/view_user.blade.php ENDPATH**/ ?>