				...
				<tbody>
					...
					<?php $__currentLoopData = $message_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<?php $count++; $counter = App\SendNotifications::where('unique_id', $item->unique_id)->count(); ?>
                            <tr data-item-id = "<?php echo e($item->unique_id); ?>" data-href = "<?php echo e(route('individualMessage', ['id'=>$item->unique_id])); ?>"  class="<?php echo e(($item->status == 0) ? 'New' : 'read'); ?> ">
                                    <td><?php echo e($count); ?></td>
                                    
                                    <td><?php echo e($item->company_name . ' (' . $counter . ')'); ?> </td>
                                    <td><?php echo e($item->title); ?></td>
                                    <td><?php echo e(date("d/m/Y H:i:sA", strtotime($item->updated_at) )); ?></td>
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\myiso_arabic\resources\views/admin/dashboard/admin/receive_notification_inbox.blade.php ENDPATH**/ ?>