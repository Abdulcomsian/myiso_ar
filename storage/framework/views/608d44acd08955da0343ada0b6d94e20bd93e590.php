        ...
        <div class="row text-right">
            ...
            <div class="col-xl-8">
                ...
                <div class="kt-portlet kt-portlet--height-fluid sd">
                        ...
                        <div class="kt-widget17 p-4">
                            <div class="row ml-0 mr-0 table-responsive">
								<?php if(!empty($user['audit_report'])): ?>
									...
									<a href="public/<?php echo e($user['audit_report']); ?>" target="_blank">
                    ...
                    <?php if(!empty($user['qa_certification'])): ?>
                     <div class="kt-portlet__head" style="border-bottom: none">
                         <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                             اتفاقية شهادة ضمان الجودة
                            </h3>
                            <a href="public/<?php echo e($user['qa_certification']); ?>" target="_blank">
                                    <i class="far fa-file-pdf fa-2x" style="color:red; margin-left: 50px"></i>
                                </a> 
                        </div>
                    </div>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/BLOCKSTORAGE/home/1629330.cloudwaysapps.com/jrxyspjtdv/public_html/public/ar/resources/views/dashboard/index.blade.php ENDPATH**/ ?>