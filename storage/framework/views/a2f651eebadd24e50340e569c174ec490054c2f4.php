...
<body>
        ...
        <div class="relative max-w-lg md:mx-auto mx-6 w-full flex flex-col justify-center bg-white rounded-lg p-6">
            <div class="text-start mb-7">
                <a href="#" class="grow block mb-8">
                     <img class=" mx-auto" src="<?php echo e(asset("/assets/media/logos/MyISOOnline-Logo.png")); ?>" alt="images"  style="width: 450px">
                </a>
    ...
    <!-- Preline Js -->
    <script src="<?php echo e(asset("js/en/js/preline.js")); ?>" ></script>

    <!-- Lucide Js -->
    <script src="<?php echo e(asset("js/en/js/lucide.min.js")); ?>" ></script>

    <!-- Main App Js -->
    <script src="<?php echo e(asset("js/en/js/app.js")); ?>" ></script>

    </body>
</html><?php /**PATH /mnt/BLOCKSTORAGE/home/1629330.cloudwaysapps.com/jrxyspjtdv/public_html/public/ar/resources/views/auth/login.blade.php ENDPATH**/ ?>