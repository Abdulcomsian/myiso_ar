...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
	...
	<div class="kt-portlet kt-portlet--mobile">
		...
		<div class="kt-portlet__body">
			...
			<form action="<?php echo e(route('storeReplyMessageAdmin')); ?>" method="post" enctype="multipart/form-data">
				<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\myiso_arabic\resources\views/admin/dashboard/admin/admin_individual_message.blade.php ENDPATH**/ ?>